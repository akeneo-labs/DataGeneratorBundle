                                ...
                                ->children()
                                    ...
                                    ->arrayNode('configuration')
                                        ->children()
                                            ...
                                            ->scalarNode('categoriesColumn')->end()
                                            ->scalarNode('familyColumn')->end()
                                            ->scalarNode('groupsColumn')->end()
                                            ->booleanNode('withHeader')->end()
                                            ->scalarNode('filePath')->end()
                                            ->booleanNode('multiple')->end()
                                            ->scalarNode('header')->end()
                                            ->scalarNode('decimalSeparator')->end()
                                            ->scalarNode('dateFormat')->end()
                                            ->booleanNode('realTimeVersioning')->end()
                                            ->arrayNode('filters')
                                                ->children()
                                                    ->arrayNode('data')->end()
                                                    ->arrayNode('structure')
